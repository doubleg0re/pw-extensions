...
async function ensureWsServer(sessionName, sessionDir, ctx) {
    ...
    const wsChild = spawn(process.execPath, [...process.execArgv, serverScript, sessionName, '--port=47831', '--host=127.0.0.1'], {
        detached: true,
